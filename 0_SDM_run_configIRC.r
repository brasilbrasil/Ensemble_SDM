...
rm(list = ls()) #removes all past worksheet variables

registryLoc = "C:/USGS_Honolulu/directory_registryIRC.r" #sets location for the registry file
#registryLoc = "Y:/PICCC_analysis/code/directory_registry" #use if running on server

source(paste0(registryLoc)) #assigns the directory_registry code as the source
