...
Process_raster_data_NeutraltoGood(spp_em_current_suitability/spp_em_current_suitability_bin, paste0('output_rasters/spp_ensembles/',masked_text,'spp_em_current_suitability'), max_lim=1, min_lim=0, mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_future_suitability/spp_em_future_suitability_bin, paste0('output_rasters/spp_ensembles/',masked_text,'spp_em_future_suitability'), max_lim=1, min_lim=0, mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_masked_current_suitability/spp_em_current_bin, paste0('output_rasters/spp_ensembles/',masked_text,'spp_em_masked_current_suitability'), max_lim=1, min_lim=0, mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_masked_future_suitability/spp_em_future_bin, paste0('output_rasters/spp_ensembles/',masked_text,'spp_em_masked_future_suitability'),max_lim=1, min_lim=0,  mask_data=mask_layer)
...
Process_raster_data_BadtoGood(avg_spp_em_suitability_delta, paste0('output_rasters/spp_ensembles/',masked_text,'spp_em_suitability_avg_delta'), max_lim=max_val, min_lim=-max_val, mask_data=mask_layer)
...
Process_raster_data_NeutraltoGood_W_overlay(spp_em_kept_range, paste0('output_rasters/spp_ensembles/',masked_text,'spp_em_kept_ranges_w_prot_areas'), mask_data=mask_layer, overlay_data=prot_areas)
...
if (BPS){
  ...
  Process_raster_data_NeutraltoGood(restoration_priority, paste0('output_rasters/spp_ensembles/',masked_text,'spp_em_restoration_priority_future'), mask_data=mask_layer)  
  ...
  Process_raster_data_NeutraltoGood(restoration_priority, paste0('output_rasters/spp_ensembles/',masked_text,'spp_em_restoration_priority_current'), mask_data=mask_layer)  
  ...
  restoration_priority=CUR_w_BPS_hab*not_cur_hab
  Process_raster_data_NeutraltoGood(restoration_priority, paste0('output_rasters/spp_ensembles/',masked_text,'spp_em_restoration_priority_gained'), mask_data=mask_layer)  
  ...
  restoration_priority=CUR_w_BPS_hab*not_cur_hab
  Process_raster_data_NeutraltoGood(restoration_priority, paste0('output_rasters/spp_ensembles/',masked_text,'spp_em_restoration_priority_kept'), mask_data=mask_layer)  
