...
bioclimDataDir ="Y:/PICCC_data/climate_data/bioclim_data_Aug2013/complete_rasters/allYrs_avg/bioclims_abs/"
...
###################################
project_name = "FB_T_and_seasonal_ppt_test" #assign project name to the current run
#choose species of interest. Due to data sensitivity, pseudo data is provided for Akekee and Akikiki as example 
spp_nm = c('Akiapolauu', 'Palila', 'Omao', 'Akekee', 'Akikiki', 'Hawaii_Amakihi', 'Hawaii_Akepa', 'Hawaii_Creeper', 
           'Apapane', 'Iiwi', 'Hawaii_Elepaio', 'Akohekohe', 'Anianiau',  'Oahu_Amakihi', 'Kauai_Elepaio', 
           'Maui_Alauahio', 'Maui_Parrotbill', 'Oahu_Elepaio', 'Puaiohi', 'Kauai_Amakihi') #'Amakihi', 'Elepaio', 
...
exclude_areas_beyond_primary_habitat=F #for shift calc
habitat_overlay=F #for multi species maps
...
dir.create(paste0(working_dir,"output_rasters/"), showWarnings = F) #creates working directory if missing
setwd(working_dir)
