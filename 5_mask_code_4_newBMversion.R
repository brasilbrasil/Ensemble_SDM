  ...
  for (sp_nm in spp_nm){
    ...
    if (file.exists(out_raster_name00)==F | overwrite==1){
      ...
      for (i in c(1,2)){
        ...
        Process_raster_data_NeutraltoGood(get(raster_name),out_nm,min_lim=0, max_lim=1000, mask_data=mask_layer)
      ...
      Process_raster_data_NeutraltoGood(masked_suitability1,out_nm,min_lim=0, max_lim=1000, mask_data=mask_layer)
      ...
      Process_raster_data_NeutraltoGood(masked_suitability2,out_nm,min_lim=0, max_lim=1000, mask_data=mask_layer)
      ...
      Process_raster_data_BadtoGood(suitability_change,out_nm,min_lim=-1000, max_lim=1000, mask_data=mask_layer)
