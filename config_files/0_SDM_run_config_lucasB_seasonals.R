...
project_name = "FB_test_seasonal" #assign project name to the current run
...
env_var_files = c("PPT_dry_season.tif", "PPT_wet_season.tif", "TMAX_dry_season.tif", "TMAX_wet_season.tif") #choose bioclimatic variables of interest - if using new clim data use ".tif" instead
