...
###################################
project_name = "FB_MA_projection_100_runs" #assign project name to the current run
#choose species of interest. Due to data sensitivity, pseudo data is provided for Akekee and Akikiki as example 
spp_nm = c('Akekee', 'Akikiki', 'Hawaii_Amakihi', 'Apapane', 'Iiwi', 'Akohekohe', 'Maui_Alauahio', 'Maui_Parrotbill')#, , 'Akikiki', 'Akohekohe', 'Anianiau',  'Oahu_Amakihi', 'Kauai_Elepaio', 'Maui_Alauahio', 'Maui_Parrotbill', 'Oahu_Elepaio', 'Puaiohi', 'Kauai_Amakihi',  ) #'Amakihi', 'Elepaio', 
