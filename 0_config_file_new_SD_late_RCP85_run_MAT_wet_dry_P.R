...
clim_data_2100=paste0("D:/PICCC_data/climate_data/Timm_et_all_projections/RCP85/500m/2070_2099/")
...
###################################
project_name = "FB_SD_late_RCP85_MatDryWet3" #assign project name to the current run
