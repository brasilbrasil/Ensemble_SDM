...
comp_projects=c('future', 'future') #put future second!
ensemble_type="ef.pmw"
#working_dir='Y:/FB analysis/FB SDM/biomod2/'
working_dir='Y:/FB analysis/FB_Base_And_Future/all_DD_merged/'
other_dir='Y:/FB analysis/FB_Base_And_Future/all_echam_merged/'
data_dirs=c(working_dir, other_dir)
eval_stat="ROC"
...
for (sp_nm in spp_nm){
  ...
  out_nm=paste('output_rasters/DD - echam/main/', sp_nm0,"_response_zones_",eval_stat, "_", ensemble_type, sep = "")
  ...
  if (file.exists(out_raster_name00)==F | overwrite==1){
    ...
    for (i in c(1,2)){
      ...
      file_name1=paste(data_dir,sp_nm,"/proj_", proj_nm, "/",sp_nm,"_AllData_Full_AllAlgos_EM.",eval_stat, sep = "")
      file_name2=paste(data_dir,sp_nm,"/proj_", proj_nm, "/",sp_nm,"_AllData_AllRun_EM.",eval_stat, sep = "")
      ...
      file_name1_bin=paste(data_dir,sp_nm,"/proj_", proj_nm, "/",sp_nm,"_AllData_Full_AllAlgos_EM.",eval_stat,".bin.",eval_stat, sep = "")
      file_name2_bin=paste(data_dir,sp_nm,"/proj_", proj_nm, "/",sp_nm,"_AllData_AllRun_EM.",eval_stat,".bin.",eval_stat, sep = "")
      ...
      out_nm=paste('output_rasters/DD - echam/', sp_nm0,"_", "suitability_",proj_nm,"_",eval_stat,"_",ensemble_type,".jpg", sep = "")
      ...
      out_nm=paste('output_rasters/DD - echam/', sp_nm0,"_", "BIN_",proj_nm,"_",eval_stat,"_",ensemble_type,".jpg", sep = "")
      jpeg_name=paste(out_nm, ".jpg", sep = "")
      out_raster_name=paste(out_nm, ".jpg", sep = "")
    ...
    if (masked){
      ...
      jpeg_name=paste('output_rasters/DD - echam/main/', sp_nm0, "_mask.jpg", sep = "")
      jpeg(jpeg_name,
           width = 10, height = 8, units = "in",
           pointsize = 12, quality = 90, bg = "white", res = 300)
      plot(all_mask)
    ...
    if (masked){
      out_nm=paste('output_rasters/DD - echam/main/', sp_nm0,"_response_zones_masked_",eval_stat, "_", ensemble_type, sep = "")
      jpeg_name=paste(out_nm, ".jpg", sep = "")
      ...
      #output suitability rasters for each image
      #suitability
      out_nm=paste('output_rasters/DD - echam/', sp_nm0,"_suitability_future_masked_",eval_stat,"_",ensemble_type, sep = "")
      jpeg_name=paste(out_nm,".jpg", sep = "")
      jpeg(jpeg_name,
           width = 10, height = 8, units = "in",
           pointsize = 12, quality = 90, bg = "white", res = 300)
      ...
      ##binary
      out_nm=paste('output_rasters/DD - echam/', sp_nm0,"_BIN_future_masked_",eval_stat,"_",ensemble_type, sep = "")
      jpeg_name=paste(out_nm, ".jpg", sep = "")
      jpeg(jpeg_name,
           width = 10, height = 8, units = "in",
           pointsize = 12, quality = 90, bg = "white", res = 300)
