...
if (server==1){
  ...
  clim_data_dir0="Y:/SDM_env_data/bioclim_variables/full extent bioclim data/all_renamed/all_baseline/100m/"
  crop_raster_dir=paste(working_dir, 'map_crop/',sep="")
}else{
  working_dir='C:/Users/lfortini/Forest bird SDM/biomod2/'
  #clim_data_dir0="C:/Users/lfortini/Data/SDM_env_data/FB_SDM_data/HI Forest Bird VA Current Enviro 100m/"
...
#env_var_files=c("Tmax.grd", "Tmin.grd", "ppt.grd", "slope.grd", "trasp.grd", "tri.grd") 
