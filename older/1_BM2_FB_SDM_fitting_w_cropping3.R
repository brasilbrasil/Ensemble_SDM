...
spp_nm=c("Akikiki","Oahu_Elepaio")# "Akekeke", "Akikiki", "Anianiau", "Kauai_Amakihi", "Kauai_Elepaio", "Puaiohi", "Oahu_Amakihi", "Oahu_Elepaio", "Apapane", "Iiwi",)   #"Akekee", "Akikiki", "Anianiau", "Apapane", "Iiwi", "Kauai_Amakihi", "Kauai_Elepaio", "Oahu_Amakihi", "Oahu_Elepaio", "Puaiohi"
server=1

models_to_run=c('GBM','RF','MAXENT')
if (server==1){
  working_dir='Y:/FB analysis/FB SDM/biomod2/duplicate_removal_test/'
