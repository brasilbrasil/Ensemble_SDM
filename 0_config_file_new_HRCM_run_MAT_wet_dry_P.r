...
bioclimDataDir = paste0(rootDir, "PICCC_data/climate_data/HRCM_151110/complete_rasters/allYrs_avg/bioclims_abs/")
fitting_clim_data_dir = paste0(bioclimDataDir,"baseline/125m/") 
clim_data_2000=paste0(bioclimDataDir,"baseline/500m/")
clim_data_2100=paste0(bioclimDataDir,"future/500m/")
...
###################################
project_name = "FB_new_HRCM_A1B_MatDryWet3" #assign project name to the current run
...
spp_ensemble_maps = T
apply_veg_overlay_mask=T

#################################
####CONFIG FOR SPECIFIC STEPS####
#################################
####fit config (script#1)
NbRunEval = 7 #number of evaluation runs for ensemble modeling
...
if (apply_veg_overlay_mask){source(paste0(codeDir,"5b_apply_veg_overlay_rasters.R"))}
