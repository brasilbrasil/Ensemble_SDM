...
###USER CONFIGURATION
spp_nm = c('Akekee', 'Akiapolauu', 'Akikiki', 'Akohekohe', 'Hawaii_Akepa', 'Hawaii_Creeper', 'Maui_Alauahio', 'Maui_Parrotbill', 'Puaiohi', 'Iiwi')#'Amakihi', 'Elepaio', 
...
##save rasters
dir.create('output_rasters/spp_ensembles_HiRelSpp/',showWarnings=F)
...
Process_raster_data_NeutraltoGood(spp_em_current_suitability/spp_em_current_suitability_bin, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_current_suitability'), max_lim=1, min_lim=0, mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_future_suitability/spp_em_future_suitability_bin, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_future_suitability'), max_lim=1, min_lim=0, mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_masked_current_suitability/spp_em_current_bin, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_masked_current_suitability'), max_lim=1, min_lim=0, mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_masked_future_suitability/spp_em_future_bin, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_masked_future_suitability'),max_lim=1, min_lim=0,  mask_data=mask_layer)
Process_raster_data_NeutraltoBad(spp_em_masked_current_suitability_CV, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_current_suitability_CV'), mask_data=mask_layer)
Process_raster_data_NeutraltoBad(spp_em_masked_future_suitability_CV, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_future_suitability_CV'), mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_current_bin, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_current_bin'), mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_future_bin, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_future_bin'), mask_data=mask_layer)
...
Process_raster_data_BadtoGood(avg_spp_em_suitability_delta, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_suitability_avg_delta'), max_lim=max_val, min_lim=-max_val, mask_data=mask_layer)

max_val=max(abs(c(cellStats(spp_em_suitability_delta,max),cellStats(spp_em_suitability_delta,min))))
Process_raster_data_BadtoGood(spp_em_suitability_delta, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_suitability_delta'), max_lim=max_val, min_lim=-max_val, mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_lost_range, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_lost_range'), mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_kept_range, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_kept_range'), mask_data=mask_layer)
Process_raster_data_NeutraltoGood(spp_em_gained_range, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_gained_range'), mask_data=mask_layer)

#MS figures
prot_areas=shapefile(paste0("Y:/PICCC_analysis/FB_analysis/habitat analysis/","protected_areas_20100331_simpleWGS1984.shp"))
Process_raster_data_NeutraltoGood_W_overlay(spp_em_kept_range, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_kept_ranges_w_prot_areas'), mask_data=mask_layer, overlay_data=prot_areas)

if (BPS){
  #future restoration priority
  FUT_w_BPS_hab=raster(paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_future_bin.tif'))  
  FUT_w_Curr_hab=raster(paste0('output_rasters/spp_ensembles_HiRelSpp/',"current_habitat_",'spp_em_future_bin.tif'))
  not_cur_hab=FUT_w_Curr_hab==0
  
  restoration_priority=FUT_w_BPS_hab*not_cur_hab
  Process_raster_data_NeutraltoGood(restoration_priority, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_restoration_priority_future'), mask_data=mask_layer)  

  #current restoration priority
  CUR_w_BPS_hab=raster(paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_current_bin.tif'))  
  CUR_w_Curr_hab=raster(paste0('output_rasters/spp_ensembles_HiRelSpp/',"current_habitat_",'spp_em_current_bin.tif'))
  not_cur_hab=CUR_w_Curr_hab==0
  
  restoration_priority=CUR_w_BPS_hab*not_cur_hab
  Process_raster_data_NeutraltoGood(restoration_priority, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_restoration_priority_current'), mask_data=mask_layer)  

  #gained restoration priority
  CUR_w_BPS_hab=raster(paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_gained_range.tif'))  
  CUR_w_Curr_hab=raster(paste0('output_rasters/spp_ensembles_HiRelSpp/',"current_habitat_",'spp_em_gained_range.tif'))
  not_cur_hab=CUR_w_Curr_hab==0
  
  restoration_priority=CUR_w_BPS_hab*not_cur_hab
  Process_raster_data_NeutraltoGood(restoration_priority, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_restoration_priority_gained'), mask_data=mask_layer)  

  #kept restoration priority
  CUR_w_BPS_hab=raster(paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_kept_range.tif'))  
  CUR_w_Curr_hab=raster(paste0('output_rasters/spp_ensembles_HiRelSpp/',"current_habitat_",'spp_em_kept_range.tif'))
  not_cur_hab=CUR_w_Curr_hab==0
  
  restoration_priority=CUR_w_BPS_hab*not_cur_hab
  Process_raster_data_NeutraltoGood(restoration_priority, paste0('output_rasters/spp_ensembles_HiRelSpp/',masked_text,'spp_em_restoration_priority_kept'), mask_data=mask_layer)  
