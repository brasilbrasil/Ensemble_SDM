...
codeDir = paste0("D:/Dropbox/code/", "Ensemble_SDM/")  
...
###################################
project_name = "FB_BI_projection_100_runs" #assign project name to the current run
...
create_habitat_clipped_response_maps=T
...
veg_overlay_eval_stat="ROC" #for veg overlay response maps
...
BPS=F #for individual and multi species vegetation overlay maps #overlay with prehistorical habitat distribution (landfire BPS)
...
if (create_habitat_clipped_response_maps){source(paste0(codeDir,"5b_apply_veg_overlay_rasters.R"))}
