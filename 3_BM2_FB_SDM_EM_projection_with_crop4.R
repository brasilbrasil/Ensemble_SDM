...
spp_nm=c("Kauai_Amakihi","Oahu_Elepaio")# "Akekeke", "Akikiki", "Anianiau", "Kauai_Amakihi", "Kauai_Elepaio", "Puaiohi", "Oahu_Amakihi", "Oahu_Elepaio", "Apapane", "Iiwi",)   #"Akekee", "Akikiki", "Anianiau", "Apapane", "Iiwi", "Kauai_Amakihi", "Kauai_Elepaio", "Oahu_Amakihi", "Oahu_Elepaio", "Puaiohi"
server=1
baseline_or_future=0 #0 for baseline, 1 for future
overwrite=1 #if 1, will overwrite past results
eval_stats=c("ROC") 


if (server==1){
  working_dir='Y:/FB_analysis/FB_SDM/biomod2/duplicate_removal_test/'
