...
project_name='finaltest_olddata_newcode__newclim_100m_noRF__P_A_medPAdens_1' #assign project name to the current run
...
spp_subset = c('Palila', 'Hawaii_Akepa', 'Maui_Parrotbill', 'Puaiohi')
...
csv_dir = paste0(working_dir,"/single_sp_CSVs/old data") #assign directory for single species CSV's
