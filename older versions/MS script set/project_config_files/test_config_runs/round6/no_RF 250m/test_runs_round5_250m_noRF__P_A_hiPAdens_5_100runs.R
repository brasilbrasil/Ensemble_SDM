...
spp_nm=c("Akekee", "Kauai_Amakihi", "Hawaii_Akepa", "Palila", "Oahu_Amakihi", "Maui_Parrotbill")
project_name='test_runs_round6_250m_noRF__P_A_hiPAdens_5_100runs'
server=1
...
dens_PAs_outside_CE=5 #if 1 will create PA density that is equal to point density within surveyed areas
PA.nb.rep=10
