...
project_name = "FB_test_diff_vars_8_9_16_17" #assign project name to the current run
...
env_var_files = c("bio8.tif", "bio9.tif", "bio16.tif", "bio17.tif") #choose bioclimatic variables of interest - if using new clim data use ".tif" instead
