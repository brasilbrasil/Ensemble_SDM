...
project_name = "FB_test20140328c" #assign project name to the current run
...
spp_subset = c("Apapane", "Hawaii_Amakihi", "Akekee") # "Oahu_Amakihi","Hawaii_Akepa", "Palila") #if only subset, enter spp names here 
