...
project_name = "FB_test20140130f" #assign project name to the current run
...
models_to_run = c("GBM", "MAXENT") #"GBM","MAXENT" #choose biomod2 models to run - possibilities are: 'GLM','GBM','GAM','CTA','ANN','SRE','FDA','MARS','RF','MAXENT' 
eval_stats = c("ROC", "TSS") #"ROC", "TSS" #choose evaluation methods - possibilties are: 'KAPPA','TSS','ROC'
...
#################################
####fit config (script#1)
NbRunEval = 1 #number of evaluation runs for ensemble modeling
