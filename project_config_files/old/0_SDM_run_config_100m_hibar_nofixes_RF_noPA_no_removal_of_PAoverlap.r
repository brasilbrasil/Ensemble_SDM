...
spp_nm=c("Akekee","Hawaii_Akepa", "Palila")#, "Kauai_Amakihi", "Oahu_Amakihi","Hawaii_Akepa", "Palila")#, "Kauai_Amakihi", "Hawaii_Akepa", "Palila")
project_name='hibar_nofixes_RF_noPA_no_removal_of_PAoverlap'
server=1
overwrite=0
