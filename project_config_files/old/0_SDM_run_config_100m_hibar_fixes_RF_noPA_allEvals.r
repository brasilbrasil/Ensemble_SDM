...
spp_nm=c("Akekee", "Hawaii_Akepa")# ,"Kauai_Amakihi", "Oahu_Amakihi", "Palila")#, "Kauai_Amakihi", "Hawaii_Akepa", "Palila")
project_name='test_runs_100m_hibar_fixes_RF_noPA_allEvals'
server=1
overwrite=0
