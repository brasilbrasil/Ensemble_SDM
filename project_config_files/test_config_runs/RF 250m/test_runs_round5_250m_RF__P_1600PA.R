...
spp_nm=c("Akekee", "Kauai_Amakihi", "Oahu_Elepaio", "Hawaii_Akepa", "Palila", "Oahu_Amakihi", "Maui_Parrotbill")
project_name='test_runs_round5_250m_RF__P_1600PA'
server=1
...
PA.nb.rep=5
PA.nb.absences = 1600 #if PAs_outside_CE=T, this will be overridden! (n of PAs will be determined by P/A point density within CE 
candidatePAperPA=0 #only used if if PAs_outside_CE=F, if value ==0, will use PA.nb.absences   
PA.strategy = "random"
