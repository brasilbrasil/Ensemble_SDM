...
project_name='test_runs_round6_100m_noRF__P_lowPAdens_500_100runs'
server=1
...
candidatePA.per.PA=500 #only used if if PAs_outside_CE=F, if value ==0, will use PA.nb.absences   
PA.strategy = "random"
