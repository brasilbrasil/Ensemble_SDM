...
project_name='test_runs_round6_250m_noRF__P_medPAdens_16_100runs'
server=1
...
candidatePA.per.PA=16 #only used if if PAs_outside_CE=F, if value ==0, will use PA.nb.absences   
PA.strategy = "random"
