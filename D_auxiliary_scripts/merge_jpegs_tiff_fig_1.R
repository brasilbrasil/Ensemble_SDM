...
wd="D:/Dropbox/current work/FB SDM/FB MS draft/not in MS/base figs/140807 version/"
setwd(wd)
#library(jpeg)
library(tiff)
#library(rasterImage)
...
for (str in strs){
  ...
  rasterImage(image2, 0.45, 0, 1, 1)
  rasterImage(image1, 0, 0, 0.55, 1)
  dev.off()
  ...
  rasterImage(image2, 0.45, 0, 1, 1)
  rasterImage(image1, 0, 0, 0.55, 1)
  text(x=0.18, y = 0.92, labels = "(a)", adj = NULL, #x=0.08, y = 0.97
       pos = NULL, offset = 0.5, vfont = NULL,
       cex = 1.8, col = "black", font = 2)
  text(x=0.63, y = 0.92, labels = "(b)", adj = NULL,
       pos = NULL, offset = 0.5, vfont = NULL,
       cex = 1.8, col = "black", font = 2)
  dev.off()
